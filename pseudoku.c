...
uint32* get_row(uint32* g, uint32 r)
{
...
uint32* get_col(uint32* g, uint32 c)
{
...
uint32* get_box(uint32* g, uint32 b)
{
...
peers* get_peers(uint32* g, uint32 n)
{
...
uint32 is_safe(uint32* g, uint32 n, uint32 v)
{
...
pos* get_pos_vals(uint32* g, uint32 n)
{
...
uint32 fill_grid(uint32* g, uint32 n)
{
    if (n < 81)
    {
	if (g[n] != 0)
...
void copy_grid(uint32* old_values, uint32* new_values)
{
    uint32 i;
    for (i = 0; i < 81; i++)
    {
